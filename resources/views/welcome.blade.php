...
<body class="antialiased text-slate-800">
    ...
    <header class="sticky top-0 z-50 bg-white/90 backdrop-blur border-b border-slate-100">
        <div class="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
            ...
            <div class="hidden md:flex items-center gap-3">
                <a href="#contact" class="bg-brand-600 hover:bg-brand-700 transition text-white text-sm font-semibold px-5 py-2.5 rounded-lg">
                    Demander une démo
                </a>
    ...
    <main>
            ...
            <div class="max-w-7xl mx-auto px-6 pt-16 pb-20 grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div>
                    ...
                    <div class="mt-8 flex flex-wrap gap-4">
                        <a href="#fonctionnalites" class="inline-flex items-center gap-2 bg-brand-600 hover:bg-brand-700 transition text-white font-semibold px-6 py-3 rounded-lg">
        ...
        <section id="fonctionnalites" class="max-w-7xl mx-auto px-6 py-16">
            ...
            <div class="mt-8 grid sm:grid-cols-2 lg:grid-cols-4 gap-6 bg-slate-50 rounded-2xl p-8">
                ...
                <div class="flex items-center gap-3">
                    <span class="text-brand-600 text-2xl">🛍️</span>
                    <div>
            ...
            <div class="max-w-7xl mx-auto px-6 py-10 grid md:grid-cols-2 gap-8 items-center">
                <div>
                    ...
                    <div class="mt-6 flex flex-wrap gap-4">
                        <a href="#contact" class="bg-white text-brand-700 font-semibold px-6 py-3 rounded-lg hover:bg-brand-50 transition">Demander une démo gratuite</a>
        ...
        <section id="contact" class="max-w-7xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-12">
            ...
            <div class="bg-slate-50 rounded-2xl p-8 space-y-4 text-sm text-slate-700 h-fit">
                <p class="flex items-center gap-3"><span>📍</span> Antananarivo, Madagascar</p>
                <p class="flex items-center gap-3"><span>✉️</span> contact@fastcaisse.mg</p>
                <p class="flex items-center gap-3"><span>📞</span> +261 34 00 000 00</p>
            </div>
        </section>
    </main>
